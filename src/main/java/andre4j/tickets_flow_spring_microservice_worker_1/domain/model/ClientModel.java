...
public class ClientModel {
    ...
    public ClientModel(String name, String age, String email, String[] phones, String cep, AddressModel address) {
        this.name = name;
        this.age = age;
        this.email = email;
        this.phones = phones;
    ...
    public String toString() {
        return "ClientModel [name=" + name + ", age=" + age + ", email=" + email + ", phones=" + Arrays.toString(phones)
