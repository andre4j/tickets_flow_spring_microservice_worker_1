...
public class ConstellationModel extends TicketModel {
  ...
  public int hashCode() {
    ...
    result = prime * result + ((recliningSeatType == null) ? 0 : recliningSeatType.hashCode());
    return result;
  }
  ...
  public boolean equals(Object obj) {
    ...
    if (recliningSeatType == null) {
      if (other.recliningSeatType != null)
        return false;
    } else if (!recliningSeatType.equals(other.recliningSeatType))
      return false;
    return true;
  }
  ...
  public String toString() {
    return ("ConstellationModel [" + super.toString() + ", recliningSeatType=" + recliningSeatType + "]");
  }
}
