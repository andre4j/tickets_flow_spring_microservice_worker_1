...
import andre4j.tickets_flow_spring_microservice_worker_1.domain.enums.TypeSection;
...
public class SectionModel {
    ...
    public SectionModel(String codeSection, Integer quantityOfArmChair, MovieModel movie, LocalDateTime dateOfSection,
            String localOfSection, State state, Boolean isPreLaunch, TypeSection typeSection) {
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + ((codeSection == null) ? 0 : codeSection.hashCode());
        result = prime * result + ((quantityOfArmChair == null) ? 0 : quantityOfArmChair.hashCode());
        result = prime * result + ((movie == null) ? 0 : movie.hashCode());
        result = prime * result + ((dateOfSection == null) ? 0 : dateOfSection.hashCode());
        result = prime * result + ((localOfSection == null) ? 0 : localOfSection.hashCode());
        result = prime * result + ((state == null) ? 0 : state.hashCode());
        result = prime * result + ((isPreLaunch == null) ? 0 : isPreLaunch.hashCode());
        result = prime * result + ((typeSection == null) ? 0 : typeSection.hashCode());
        return result;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (codeSection == null) {
            if (other.codeSection != null)
                return false;
        } else if (!codeSection.equals(other.codeSection))
            return false;
        if (quantityOfArmChair == null) {
            if (other.quantityOfArmChair != null)
                return false;
        } else if (!quantityOfArmChair.equals(other.quantityOfArmChair))
            return false;
        if (movie == null) {
            if (other.movie != null)
                return false;
        ...
        if (dateOfSection == null) {
            if (other.dateOfSection != null)
                return false;
        } else if (!dateOfSection.equals(other.dateOfSection))
            return false;
        if (localOfSection == null) {
            if (other.localOfSection != null)
                return false;
        } else if (!localOfSection.equals(other.localOfSection))
            return false;
        ...
        if (isPreLaunch == null) {
            if (other.isPreLaunch != null)
                return false;
        } else if (!isPreLaunch.equals(other.isPreLaunch))
            return false;
    ...
    public String toString() {
        return "SectionModel [codeSection=" + codeSection + ", quantityOfArmChair=" + quantityOfArmChair + ", movie="
                + movie + ", dateOfSection=" + dateOfSection + ", localOfSection=" + localOfSection + ", state=" + state
                + ", isPreLaunch=" + isPreLaunch + ", typeSection=" + typeSection + "]";
    }
}
