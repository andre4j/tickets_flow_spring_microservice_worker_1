...
import andre4j.tickets_flow_spring_microservice_worker_1.domain.enums.ListOfCompanies;
import andre4j.tickets_flow_spring_microservice_worker_1.domain.enums.StatusOfTicket;
...
public class TicketModel {
    ...
    public TicketModel(UUID id, SectionModel section, ClientModel client, LocalDateTime dateOfTicketGenerated,
            StatusOfTicket statusOfTicket, ListOfCompanies listOfCompanies) {
        this.id = id;
    ...
    public int hashCode() {
        ...
        result = prime * result + ((dateOfTicketGenerated == null) ? 0 : dateOfTicketGenerated.hashCode());
        result = prime * result + ((statusOfTicket == null) ? 0 : statusOfTicket.hashCode());
        result = prime * result + ((listOfCompanies == null) ? 0 : listOfCompanies.hashCode());
        return result;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (dateOfTicketGenerated == null) {
            if (other.dateOfTicketGenerated != null)
                return false;
        } else if (!dateOfTicketGenerated.equals(other.dateOfTicketGenerated))
            return false;
    ...
    public String toString() {
        return "TicketModel [id=" + id + ", section=" + section + ", client=" + client + ", dateOfTicketGenerated="
                + dateOfTicketGenerated + ", statusOfTicket=" + statusOfTicket + ", listOfCompanies=" + listOfCompanies
                + "]";
    }
}
